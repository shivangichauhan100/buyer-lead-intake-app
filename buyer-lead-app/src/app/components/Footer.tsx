        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          >
            <div className="flex items-center mb-6">
              <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-3">
                🏠
              </div>
              <span className="text-2xl font-bold">PropertyPro</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              The future of real estate is here. Find your dream home with AI-powered matching, 
              virtual tours, and expert guidance every step of the way.
            </p>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 PropertyPro. All rights reserved. Made with ❤️ for home buyers.
            </div>
